...
| `icon`          |          | `string` \| `ImageMetadata`                  | Avatar icon metadata/URL.                                                                                                                                                                                                                                                                                                                             |
| `previewImages` |          | array includes `string` or `ImageMetadata`   | Array of preview image metadata/URLs used in marketplaces, etc.                                                                                                                                                                                                                                                                                       |
