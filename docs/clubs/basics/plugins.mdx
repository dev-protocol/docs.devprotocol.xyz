...
|                                                   | Pages        | Admin pages  | Slots        | Layouts      |
| ------------------------------------------------- | ------------ | ------------ | ------------ | ------------ |
| [`getPagePaths`](../guides/plugin#getpagepaths)   | <Required /> | <Optional /> | <Optional /> | <Optional /> |
| [`getAdminPaths`](../guides/plugin#getadminpaths) | <Optional /> | <Required /> | <Optional /> | <Optional /> |
| [`getSlots`](../guides/plugin#getslots)           | <Optional /> | <Optional /> | <Required /> | <Optional /> |
| [`getLayout`](../guides/plugin#getlayout)         | <Optional /> | <Optional /> | <Optional /> | <Required /> |
| [`meta`](../guides/plugin#meta)                   | <Required /> | <Required /> | <Required /> | <Required /> |
